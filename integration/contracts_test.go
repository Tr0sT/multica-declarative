...
func TestOfficialCLIContracts(t *testing.T) {
	...
	contracts := map[string][]string{
		"project list":             {"output"},
		"project get":              {"output"},
		"project create":           {"title", "description", "status", "icon", "lead", "start-date", "due-date"},
		"project update":           {"title", "description", "status", "icon", "lead", "start-date", "due-date"},
		"project resource list":    {"output"},
		"project resource add":     {"type", "ref", "label", "output"},
		"project resource update":  {"ref", "label", "position", "output"},
		"project resource remove":  {"output"},
		"autopilot list":           {"output"},
		"autopilot get":            {"output"},
		"autopilot create":         {"title", "description", "agent", "project", "mode", "issue-title-template", "subscriber"},
		"autopilot update":         {"title", "description", "agent", "project", "status", "mode", "issue-title-template", "subscriber", "clear-subscribers"},
		"autopilot trigger-add":    {"kind", "cron", "timezone", "label", "output"},
		"autopilot trigger-update": {"enabled", "cron", "timezone", "label", "output"},
